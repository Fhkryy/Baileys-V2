...
<p align="center">
  <img src="https://img2.pixhost.to/images/8544/737302502_fhkry.jpg" alt="Thumbnail" />
</p>
...
await sock.sendMessage(jid, { 
    eventMessage: { 
        ...
        joinLink: "https://call.whatsapp.com/video/fhkry666", 
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/Fhkry666",
                    merchant_url: "https://t.me/Fhkry666"
                })
            }
        ]
    }
